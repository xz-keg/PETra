...
def _add_training_args(parser):
    ...
    group.add_argument('--version', type=int,default=0,
                       help='data version to be used.')
    group.add_argument('--chronic-weight', type=float,default=0.00,
                       help='chronic decay weight')
    group.add_argument('--no-use-weighted', action='store_false',
                       help='use weight or not, default is true')
    group.add_argument('--training-dataset', type=str,default='2024-08-13',
                       help='training dataset')
    group.add_argument('--train-start-date', type=str,default='2019-01-01',
                       help='train dataset start date')
    group.add_argument('--valid-dataset', type=str,default='2024-10-01',
                       help='validation dataset')
    group.add_argument('--valid-start-date', type=str,default='2024-08-14',
                       help='validation dataset start date')
    group.add_argument('--valid-month', type=str,default=None,
                       help='validation month')
    group.add_argument('--total-rank', type=int,default=32,
                       help='total rank')
    return parser
...
def _add_data_args(parser):
    ...
    group.add_argument('--valid-data-path', nargs='*', default=None,
                       ...
                       'Follows the same pattern rules as --data-path.')
    group.add_argument('--log-path', nargs='*', default=None,
                       help='where the output is loged.')
