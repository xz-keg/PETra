...
def forward_backward_no_pipelining(
    *,
    ...
    #print(output_tensor,num_tokens)
    total_num_tokens += num_tokens.item()
...
def forward_backward_pipelining_without_interleaving(
    *,
    ...
    print(num_warmup_microbatches, num_microbatches_remaining)
    if num_warmup_microbatches==0:
        # set up a 100 warmup batches to avoid receiving zero things
        num_dataset_builder_threads=100
    ...
    print(recv_tensor_shapes, config)
